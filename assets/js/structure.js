...
(function () {
  ...
  // Из четырёх типов съёмки п. 5.2.1 ТЗ осталось два. Крупный план поверхности
  // ничего не добавляет к общему плану, а «вид со стороны основного потока»
  // дублирует его: сторона A по определению обращена к потоку.
  var PHOTO_TYPES = ["Общий план", "Окружение"];
