...
(function () {
  ...
  // Крупный план поверхности исключён из п. 5.2.1 ТЗ решением заказчика: на плакате
  // 1,2×1,8 м он не добавляет к общему плану ничего, ради чего стоит выезжать.
  var PHOTO_TYPES = ["Общий план", "Вид со стороны потока", "Окружение"];
