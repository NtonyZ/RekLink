 ...
 * реалистично: медиа-скроллеры почти распроданы, статичный плакат простаивает.
 */
(function (global) {
  "use strict";
  ...
  // медиа-скроллеров, январь/апрель/май/июнь); остальные месяцы интерполированы.
  var COMMERCIAL_RATE = {
  ...
  // Доля свободных плакатных позиций, занятых социальной рекламой (на медиа-скроллерах
